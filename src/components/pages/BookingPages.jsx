      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-8">
            <div className="bg-dark-grey rounded-12 shadow-2 py-15 px-20">
            ...
            <div className="bg-dark-grey rounded-12 shadow-2 py-30 px-30 md:py-20 md:px-20 mt-30">
              {bookingStage == 1 && (
                <div>
              ...
              >
                <button
                  onClick={() => setBookingStage((pre) => pre - 1)}
                  className={`button -md -dark-1 bg-accent-1 text-white ${
                    bookingStage == 1
                      ? "hiddenButtonBooking ButtonBooking"
                      : "ButtonBooking"
                  } `}
                >
                  Previous
          ...
          <div className="col-lg-4">
            <div className="pl-50 md:pl-0">
              <div className="bg-dark-grey rounded-12 shadow-2 py-30 px-30 md:py-20 md:px-20">
